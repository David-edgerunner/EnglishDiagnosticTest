...
export function computeDiagnosis(diagnosis, t) {
  ...
  // explanation_vi is now stored directly on each item in itemBank.
  // wrongAnswers items are spread from response objects which carry
  // the full item shape, so explanation_vi is already present.
  // We normalise: empty string → null so consumers can use truthiness.
