...
export const IRT_CONFIG = {
  ...
  testLengthConstraints: {
    quick: { maxItems: 20, minItems: 20, seThreshold: 0.32 },
    full: { maxItems: 40, minItems: 30, seThreshold: 0.25 }
  },
  ...
  // ─── CEFR Band Thresholds ───
  // Upper score boundary (inclusive) for each band on the 0–100 scale.
  // Scores above the C1 threshold are classified as C2.
  cefrThresholds: { A2: 20, B1: 42, B2: 68, C1: 88 },
};
