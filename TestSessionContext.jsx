...
import { ITEM_BANK } from './itemBank/index.js';
...
export function TestSessionProvider({ children }) {
  ...
  const handleConfirm = useCallback(() => {
    ...
    const newResponse = {
      ...
      explanation_text: item.explanation_text, explanation_vi: item.explanation_vi || null,
  ...
  }), [page, lang, goalType, testLength, fadeClass, responses, currentItem,
       theta, se, selectedOption, confirmed, results,
       startTest, handleConfirm, navigateTo, resetSession]);
