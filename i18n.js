...
export const i18n = {
  en: {
    ...
    landingFeatures: ["CEFR A2–C2", "IELTS Estimate", "Weakness Diagnosis", "Study Roadmap"],
    ...
    cefrDescriptions: {
      ...
      C2: "You can understand virtually everything you hear or read with ease. You can summarise information from different spoken and written sources and express yourself spontaneously, very fluently and precisely.",
    },
    score: "Score",
    ...
    goalStatements: {
      A: { A2: "Reach B1 and build the foundation for IELTS Band 4.5.", B1: "Reach B2 and target IELTS Band 6.0.", B2: "Reach C1 and target IELTS Band 7.0+.", C1: "Reach C2 and achieve IELTS Band 8.0.", C2: "You've reached the summit. Maintain this level and target IELTS Band 8.5–9.0." },
      B: { A2: "Reach B1 and begin handling basic academic texts.", B1: "Reach B2 and meet most university English requirements.", B2: "Reach C1 and meet top university language requirements.", C1: "Reach C2 and publish academic work indistinguishable from native speakers.", C2: "You've reached the summit. Your English is indistinguishable from an educated native speaker for all academic purposes." },
      C: { A2: "Reach B1 and handle basic workplace communication.", B1: "Reach B2 and communicate professionally in meetings and emails.", B2: "Reach C1 and present, negotiate, and write at a professional native level.", C1: "Reach C2 and lead at the highest level in any English-language environment.", C2: "You've reached the summit. Lead, present, and write in any professional English environment without limitation." },
      D: { A2: "Reach B1 and follow English shows with subtitles.", B1: "Reach B2 and watch English films without needing subtitles.", B2: "Reach C1 and appreciate humour, nuance, and subtext in English media.", C1: "Reach C2 and lose yourself entirely in English-language content.", C2: "You've reached the summit. Enjoy English-language culture at its deepest level — literature, humour, and subtext." },
      E: { A2: "Reach B1 and expand your everyday English confidence.", B1: "Reach B2 and unlock academic and professional fluency.", B2: "Reach C1 and achieve full professional proficiency.", C1: "Reach C2 and master English at the highest level.", C2: "You've reached the summit. Maintain and enjoy your mastery-level English." },
    },
    ...
    cefrDNA: {
      ...
      C2: {
        headline: "You command English at native-level mastery",
        capability: "At C2, you can understand virtually any written or spoken English, convey fine shades of meaning precisely, and navigate the most complex academic and professional contexts. IELTS 8.0–9.0 territory.",
      },
    },
    ...
    honestTimeline: {
      ...
      C2: {
        ...
        body: "At C2, your next step is maintenance and application — reading widely in your domain, producing sophisticated written work, and exposing yourself to native-level discussions.",
      },
    },
    ...
    englishDnaTitle: "Your English DNA",
    weakLinkCost: "Fixing this is worth {bandCost} on IELTS. Your fastest route forward runs through here.",
    unlockCardFix: "Fix this and {fix}",
  },
  vi: {
    ...
    landingFeatures: ["CEFR A2–C2", "Ước Tính IELTS", "Phân Tích Điểm Yếu", "Lộ Trình Học Tập"],
    ...
    cefrLabels: {
      ...
      C2: "Thành thạo — Trình Độ Như Người Bản Xứ",
    },
    cefrDescriptions: {
      ...
      C2: "Bạn có thể hiểu hầu hết mọi thứ nghe hoặc đọc một cách dễ dàng. Bạn có thể tóm tắt thông tin từ nhiều nguồn khác nhau và diễn đạt tự nhiên, rất trôi chảy và chính xác.",
    },
    score: "Điểm",
    ...
    goalStatements: {
      A: { A2: "Đạt B1 và xây dựng nền tảng cho IELTS Band 4.5.", B1: "Đạt B2 và hướng đến IELTS Band 6.0.", B2: "Đạt C1 và hướng đến IELTS Band 7.0+.", C1: "Đạt C2 và đạt IELTS Band 8.0.", C2: "Bạn đã đạt đỉnh cao. Duy trì trình độ này và hướng đến IELTS Band 8.5–9.0." },
      B: { A2: "Đạt B1 và bắt đầu đọc hiểu văn bản học thuật cơ bản.", B1: "Đạt B2 và đáp ứng yêu cầu tiếng Anh đại học.", B2: "Đạt C1 và đạt yêu cầu ngôn ngữ của các trường hàng đầu.", C1: "Đạt C2 và viết học thuật như người bản xứ.", C2: "Bạn đã đạt đỉnh cao. Tiếng Anh của bạn không thể phân biệt với người bản xứ có học thức trong mọi mục đích học thuật." },
      C: { A2: "Đạt B1 và xử lý giao tiếp công việc cơ bản.", B1: "Đạt B2 và giao tiếp chuyên nghiệp trong họp và email.", B2: "Đạt C1 và thuyết trình, đàm phán ở mức chuyên nghiệp.", C1: "Đạt C2 và lãnh đạo ở mức cao nhất trong môi trường tiếng Anh.", C2: "Bạn đã đạt đỉnh cao. Lãnh đạo, thuyết trình và viết trong bất kỳ môi trường tiếng Anh chuyên nghiệp nào mà không có giới hạn." },
      D: { A2: "Đạt B1 và theo dõi chương trình tiếng Anh có phụ đề.", B1: "Đạt B2 và xem phim tiếng Anh không cần phụ đề.", B2: "Đạt C1 và cảm nhận sự hài hước, tinh tế trong nội dung tiếng Anh.", C1: "Đạt C2 và hoàn toàn đắm chìm trong nội dung tiếng Anh.", C2: "Bạn đã đạt đỉnh cao. Tận hưởng văn hóa tiếng Anh ở mức sâu nhất — văn học, sự hài hước và tinh tế ngầm." },
      E: { A2: "Đạt B1 và mở rộng sự tự tin tiếng Anh hàng ngày.", B1: "Đạt B2 và mở khóa khả năng học thuật và chuyên nghiệp.", B2: "Đạt C1 và đạt thành thạo chuyên nghiệp toàn diện.", C1: "Đạt C2 và làm chủ tiếng Anh ở mức cao nhất.", C2: "Bạn đã đạt đỉnh cao. Duy trì và tận hưởng trình độ tiếng Anh thành thạo của bạn." },
    },
    ...
    cefrDNA: {
      ...
      C2: {
        headline: "Bạn làm chủ tiếng Anh ở trình độ như người bản ngữ",
        capability: "Ở trình độ C2, bạn có thể hiểu hầu hết mọi tiếng Anh nói hoặc viết, truyền đạt ý nghĩa tinh tế chính xác và điều hướng các bối cảnh học thuật và chuyên nghiệp phức tạp nhất. Tương đương IELTS 8.0–9.0.",
      },
    },
    ...
    honestTimeline: {
      ...
      C2: {
        headline: "Bạn đã đến đích rồi",
        body: "Ở C2, bước tiếp theo là duy trì và ứng dụng — đọc rộng trong lĩnh vực của bạn, tạo ra các tác phẩm viết phức tạp và tiếp xúc với các cuộc thảo luận ở trình độ người bản xứ.",
      },
    },
    ...
    englishDnaTitle: "DNA tiếng Anh của bạn",
    weakLinkCost: "Cải thiện điểm này giúp bạn tăng {bandCost} band IELTS. Đây là con đường nhanh nhất để tiến lên.",
    unlockCardFix: "Cải thiện điều này và {fix}",
  }
};
